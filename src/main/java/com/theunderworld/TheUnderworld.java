...
public class TheUnderworld implements ModInitializer {
	...
	private static final ItemGroup THE_UNDERWORLD_GROUP = FabricItemGroup.builder()
		...
		.entries((context, entries) -> {
			...
			entries.add(BlocksCollection.SMOOTH_DREADSTONE);
			entries.add(BlocksCollection.SMOOTH_DREADSTONE_STAIRS);
			entries.add(BlocksCollection.SMOOTH_DREADSTONE_SLAB);
			entries.add(BlocksCollection.SMOOTH_DREADSTONE_WALL);
			...
			entries.add(BlocksCollection.DEAD_SHRUB);
			...
			entries.add(ItemsCollection.RADIANT_OPACITITE_SWORD);
			entries.add(ItemsCollection.RADIANT_OPACITITE_HELMET);
			entries.add(ItemsCollection.RADIANT_OPACITITE_CHESTPLATE);
			entries.add(ItemsCollection.RADIANT_OPACITITE_LEGGINGS);
			entries.add(ItemsCollection.RADIANT_OPACITITE_BOOTS);
			entries.add(ItemsCollection.DREADDED_OPACITITE_SWORD);
			entries.add(ItemsCollection.DREADDED_OPACITITE_HELMET);
			entries.add(ItemsCollection.DREADDED_OPACITITE_CHESTPLATE);
			entries.add(ItemsCollection.DREADDED_OPACITITE_LEGGINGS);
			entries.add(ItemsCollection.DREADDED_OPACITITE_BOOTS);
			entries.add(ItemsCollection.SWIFT_OPACITITE_SWORD);
